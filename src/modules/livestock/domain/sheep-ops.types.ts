...
/**
 * Sheep Farm operations DTOs + row mappers — mirrors
...
export function rowToSheepDailyRecord(r: SheepDailyRecordRow): SheepDailyRecord {
  return {
    id: r.id,
...
export type UpdateSheepDailyRecordInput = Partial<Omit<CreateSheepDailyRecordInput, 'recordDate'>>;

export interface ListSheepDailyRecordsFilter {
  page: number;
  pageSize: number;
  from?: string;
  to?: string;
...
// =====================================================================
// Sheep health events (treatments & vaccinations)
// =====================================================================
...
export interface SheepHealthEventRow {
  id: string;
  sheep_batch_id: string;
  organization_id: string;
  kind: string;
...
export function rowToSheepHealthEvent(r: SheepHealthEventRow): SheepHealthEvent {
  return {
    id: r.id,
    sheepBatchId: r.sheep_batch_id,
    organizationId: r.organization_id,
...
export type UpdateSheepHealthEventInput = Partial<CreateSheepHealthEventInput>;

export interface ListSheepHealthEventsFilter {
  page: number;
  pageSize: number;
  kind?: LivestockHealthEventKind;
  status?: LivestockHealthEventStatus;
...
export function rowToSheepCase(r: SheepCaseRow, imageUrl: string | null): SheepCase {
  return {
    id: r.id,
    sheepBatchId: r.sheep_batch_id,
    organizationId: r.organization_id,
...
export type UpdateSheepCaseInput = Partial<CreateSheepCaseInput> & {
  status?: LivestockCaseStatus;
};

export interface ListSheepCasesFilter {
  page: number;
  pageSize: number;
  status?: LivestockCaseStatus;
}
