...
import type { SheepHealthEventService } from '../application/sheep-health-event.service.js';
import type {
  CreateCaseBody,
...
/** HTTP adapter for Sheep Farm daily records / health events / individual cases. No business logic. */
export class SheepOpsController {
  constructor(
    private readonly daily: SheepDailyRecordService,
