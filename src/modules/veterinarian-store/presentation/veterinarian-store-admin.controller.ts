...
import type { VeterinarianStoreAdminService } from '../application/veterinarian-store-admin.service.js';
import type {
...
/** Admin / supervisor HTTP adapter for Veterinarian Store management. */
export class VeterinarianStoreAdminController {
  constructor(
    private readonly admin: VeterinarianStoreAdminService,
