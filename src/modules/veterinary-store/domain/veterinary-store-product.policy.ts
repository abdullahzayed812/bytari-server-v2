...
import { VETERINARY_STORE_ORG_TYPE } from './veterinary-store-product.constants.js';

/** Veterinary Store product business rules. Pure — no I/O. Services call these. */
export const VeterinaryStoreProductPolicy = {
  /**
   * Product management is only available for VETERINARY_STORE organizations.
   * A Veterinary Office is a fully separate domain (`veterinary-office-products`)
   ...
   * (also guarded by the `chk_vsp_stock` DB CHECK — this gives a clean 409).
   */
