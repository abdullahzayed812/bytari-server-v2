...
import type { VeterinaryStoreProductService } from '../application/veterinary-store-product.service.js';
import { requireVeterinaryStoreProduct } from './veterinary-store-product.middleware.js';
import type {
  AdjustVeterinaryStoreStockBody,
  CreateVeterinaryStoreProductBody,
  FinalizeVeterinaryStoreProductImageBody,
  ListVeterinaryStoreProductsQuery,
  VeterinaryStoreProductImageUploadUrlBody,
  UpdateVeterinaryStoreProductBody,
} from './veterinary-store-product.schemas.js';

/** Veterinary Store product HTTP adapter. No business logic. */
export class VeterinaryStoreProductController {
  constructor(private readonly products: VeterinaryStoreProductService) {}
  ...
  create = async (req: Request, res: Response): Promise<void> => {
    ...
    const body = validatedBody<CreateVeterinaryStoreProductBody>(req);
  ...
  list = async (req: Request, res: Response): Promise<void> => {
    const org = requireOrganization(req);
    const q = validatedQuery<ListVeterinaryStoreProductsQuery>(req);
  ...
  getOne = async (req: Request, res: Response): Promise<void> => {
    const org = requireOrganization(req);
    const product = requireVeterinaryStoreProduct(req);
  ...
  update = async (req: Request, res: Response): Promise<void> => {
    const org = requireOrganization(req);
    const product = requireVeterinaryStoreProduct(req);
    const body = validatedBody<UpdateVeterinaryStoreProductBody>(req);
  ...
  adjustStock = async (req: Request, res: Response): Promise<void> => {
    const org = requireOrganization(req);
    const product = requireVeterinaryStoreProduct(req);
    const body = validatedBody<AdjustVeterinaryStoreStockBody>(req);
    sendSuccess(
      res,
  ...
  requestImageUploadUrl = async (req: Request, res: Response): Promise<void> => {
    const org = requireOrganization(req);
    const product = requireVeterinaryStoreProduct(req);
    const body = validatedBody<VeterinaryStoreProductImageUploadUrlBody>(req);
  ...
  addImage = async (req: Request, res: Response): Promise<void> => {
    const org = requireOrganization(req);
    const product = requireVeterinaryStoreProduct(req);
    const body = validatedBody<FinalizeVeterinaryStoreProductImageBody>(req);
